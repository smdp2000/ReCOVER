...
function Row() {
  ...
  Papa.parse(u_cases, {
    ...
    complete: (results) => {
      ...
      setRowState({
        ...rowState,
        data_date: results.data[0].slice(2).map((y) => y.concat("T23:00:00Z")),
      });
  ...
  Papa.parse(u_case_preds, {
    ...
    complete: (results) => {
      ...
      setRowState({
        ...rowState,
        pred_date: results.data[0].slice(2).map((y) => y.concat("T23:00:00Z")),
      });
        ...
        <div className="introduction">
          ...
          <Row>
            <p>
              ...
              <a href="#/"> main page</a>. Forecasts are available for all
              locations (around 20,000) for which Google makes its data
              <a
                ...
                <Col>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Checkbox defaultChecked value="cases">
                          Cases
                        </Checkbox>
        ...
        <div className="introduction">
          <Row>
            <div style={{ background: "#fae3a2" }}>
              <p>
                [<b>Note</b>: The data is noisy for some regions with decreasing
                cumulative values and missing values. In some cases, the
                forecast for a region may be lower than one of its sub-region
                which could be a result of less availabiltiy and more noise at
                the sub-region level. In that case, the sub-region data and
                forecast are less reliable, yet not impossible, and may point
                toward possible new outbreaks. See below for our forecasts from
                alternative sources that are less noisy and should be preferred
                for country-level and state-level for US, Germnany, and Poland.]
              </p>
            </div>
          </Row>
          <Row>
            <p>
              Use the following links to download CSV files to analyze yourself
          ...
          <Row>
            ...
            <p>
              The following are the latest forecasts for Countries and the US
              states used on the main forecast page. These files are based on
              the{" "}
          ...
          <Row>
            <p>
              ...
              for dated forecasts for German states and Polish Voivodeships.
              These files are based on the data compiled by
              <a
