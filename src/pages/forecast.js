			...
			<div className="grid">
							...
							<Popover
								...
								<Form.Item
									...
									<Select
										...
										{arealist.length > 0 && arealist.map(s => 
				...
				<div className = "introduction">
					...
					<Row>
						...
						<p>
							The following are the latest forecasts for Countries and the US states used on the main forecast page. These files are based on 
					...
					<Row>
						<p>
							Follow  this <a href = "https://github.com/scc-usc/ReCOVER-COVID-19/tree/master/results/historical_forecasts"> link </a> for
